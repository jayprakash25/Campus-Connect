  ...
  return (
    <div className="grid place-items-center px-5 py-4 bg-[#F0F0F0]">
      ...
      <div className=" text-center py-8 ">
        ...
        {/* <h1 className="text-lg font-bold text-slate-800">WEATHER</h1> */}
        {/* <p className="text-sm text-slate-500 font-semibold">{}</p> */}
      </div>
      {/* <div className="border-[1px] py-6 border-gray-100"></div> */}
